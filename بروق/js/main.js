...
hizmetlerLink.addEventListener("click", function (e) {
  ...
  e.preventDefault();
  hizmetMenu.style.display =
    hizmetMenu.style.display === "block" ? "none" : "block";
...
eticaret.addEventListener("click", (e) => {
  e.preventDefault();
  eticaretMenu.style.display =
    eticaretMenu.style.display === "block" ? "none" : "block";
});
...
projelerLink.addEventListener("click", function (e) {
  e.preventDefault();
  projeMenu.style.display =
    projeMenu.style.display === "block" ? "none" : "block";
